class ModularButton {
    constructor(label, trigger, columnStart, columnEnd, rowStart, rowEnd, writeLoc, writeType) {
        ...
        this.boxLabel.addEventListener('keydown', this.onTrigger);
        this.boxLabel.addEventListener('click', this.onTrigger);
        this.boxCount.addEventListener('keydown', this.onTrigger);
    ...
    onTrigger(event) {
        ...
        if (event.key.toLowerCase() == this.hotkey || event.type === 'click') {
